...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>CN-4-0</description>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>25.77879220646626</x>
        <y>2.634457130700035</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>20.42585218594778</x>
        <y>10.342118252806937</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>11.028523932356922</x>
        <y>11.422399787083954</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>6.22323850468712</x>
        <y>4.4069628628761315</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>11.496728247962725</x>
        <y>-2.599580641198418</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>19.689346026285012</x>
        <y>-2.2889266674834285</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>12.694355188299472 0.0 0.0 12.694355188299472 4.5637447919380385 119.07949442327319</viewport>
    </plugin_config>
    <width>400</width>
    <z>6</z>
    <height>400</height>
...
sf=sl+date+"_Test_Normal_Circle_4+0_1s_log_"; //save file name     &#xD;
i=1; //file index&#xD;
