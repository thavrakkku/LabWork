...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>30.297507992637257</x>
        <y>29.78759947930691</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>30.356368372931417</x>
        <y>10.449404403604833</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>50.40721453271754</x>
        <y>10.056857929711036</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>49.81719176747763</x>
        <y>30.199305225492964</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>69.45775758438218</x>
        <y>50.32905738476179</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.379823973890775 0.0 0.0 5.379823973890775 -17.306873061516704 -1.1123116874181302</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
m2_receive_from_8 =0;&#xD;
m2_receive_from_9 =0;&#xD;
m2_receive_from_10 =0;&#xD;
m2_receive_from_11 =0;&#xD;
m2_receive_from_12 =0;&#xD;
m2_receive_from_13 =0;&#xD;
m2_receive_from_14 =0;&#xD;
m2_receive_from_15 =0;&#xD;
m2_receive_from_16 =0;&#xD;
m2_receive_from_17 =0;&#xD;
m2_receive_from_18 =0;&#xD;
m2_receive_from_19 =0;&#xD;
m2_receive_from_20 =0;&#xD;
m3_sending =0;&#xD;
m3_receiving =0&#xD;
m4_sending =0;&#xD;
m4_receiving =0&#xD;
    ...
    //log.log("1-"+msgArray[0]+"\n"); //test message after splite&#xD;
        ...
        //log.log("leng:"+msgArray.length+"\n");&#xD;
            //log.log(msgArray[1]);&#xD;
                ...
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:000b]")){&#xD;
                    m2_send_to_11 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:000c]")){&#xD;
                    m2_send_to_12 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:000d]")){&#xD;
                    m2_send_to_13 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:000e]")){&#xD;
                    m2_send_to_14 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:000f]")){&#xD;
                    m2_send_to_15 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:0010]")){&#xD;
                    m2_send_to_16 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:0011]")){&#xD;
                    m2_send_to_17 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:0012]")){&#xD;
                    m2_send_to_18 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:0013]")){&#xD;
                    m2_send_to_19 ++;&#xD;
                } &#xD;
                if(msgArray[4].equals("[aaaa:0000:0000:0000:c30c:0000:0000:0014]")){&#xD;
                    m2_send_to_20 ++;&#xD;
                } &#xD;
